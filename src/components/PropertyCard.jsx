...
import { MapPin, ShieldCheck, Wifi, UserCheck, Heart } from 'lucide-react';
  ...
  return (
    <div className="group relative rounded-2xl bg-white border border-gray-100 shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden flex flex-col">
      ...
      <div className="relative aspect-[4/3] w-full overflow-hidden bg-gray-100">
        ...
        />
        <button className="absolute top-3 right-3 p-2 rounded-full bg-white/80 backdrop-blur-md text-gray-700 hover:text-red-500 hover:bg-white transition">
      ...
      <div className="p-4 flex-1 flex flex-col justify-between">
        ...
        <div className="mt-4 pt-3 border-t border-gray-100 flex items-center justify-between">
          ...
          <button className="text-xs font-semibold text-[#168A45] hover:underline">
            বিস্তারিত দেখুন →
          </button>
        </div>
      </div>
